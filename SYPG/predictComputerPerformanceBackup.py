...
def train():       
    ...
    for i in range(random_state_number, random_state_number+20):
        x_train, x_test, y_train, y_test = sklearn.model_selection.train_test_split(x, y, test_size=20, random_state=i)
